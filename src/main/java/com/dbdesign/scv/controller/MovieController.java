...
public class MovieController {
    ...
    // 영화 등록 (어드민)
    @PostMapping
    @ApiOperation(value = "영화 등록", notes = "영화 관리자는 영화명, 상영길이, 등급, 감독명, 배우명, 장르, 영화소개, 배급사, 포스터 URL을 입력해 영화를 등록할 수 있습니다.")
    ...
    // 영화 정보 수정 (어드민)
    @PatchMapping
    @ApiOperation(value = "영화 정보 수정", notes = "영화 관리자는 상영길이, 등급, 감독명, 배우명, 장르, 영화소개, 배급사, 포스터 URL을 새로 입력해 영화 정보를 수정할 수 있습니다.")
    ...
    // 영화 삭제 (어드민)
    @PatchMapping("/delete")
    @ApiOperation(value = "영화 삭제", notes = "논리적 삭제를 하며, 상영 일정이 없는 영화의 경우에만 삭제가 가능합니다.")
    ...
    // 새로운 장르 등록 (어드민)
    @PostMapping("/genre")
    @ApiOperation(value = "영화 장르 등록", notes = "영화 관리자는 새로운 장르를 등록할 수 있습니다.")
